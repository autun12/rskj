...
public class ChannelManagerImplTest {
    ...
    public void blockAddressIsNotAvailable() throws UnknownHostException {
        ...
        Integer peerChannelReadTimeout = config.peerChannelReadTimeout();
        NodeManager nodeManager = new NodeManager(null, config);

        Channel peer = spy(new Channel(null, null, null, null, nodeManager, null, null, peerChannelReadTimeout));
        ...
        Channel otherPeer = new Channel(null, null, null, null, nodeManager, null, null, peerChannelReadTimeout);
